...
{
 $query = "SELECT * FROM announcements WHERE status='confirmed' && BINARY Email IN ('College Department','All') ORDER BY id ASC";
...
<html>
 ...
 <body>
  <br />
  <div class="container">
   <h2 align="center">Welcome to SFC College Department</h2>
   <br />
