...
{
 $query = "SELECT * FROM announcements WHERE status='confirmed' && BINARY Email IN ('Senior High School Department','All') ORDER BY id ASC";
...
<html>
 ...
 <body>
  <br />
  <div class="container">
   <h2 align="center">Welcome to SFC Senior High School Department</h2>
   <br />
