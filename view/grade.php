                		...
                		<div class="panel">
                            ...
                            <div class="panel-body"> <!-- Start of modal body--> 
                                ...
                                <div class="form-group" id="divAFeeUpdate">
                                    ...
                                    <input class="hide" value="0" type="text" id="admission_fee1" name="admission_fee" autocomplete="off">
                                </div>
                                <div class="form-group" id="divHChargeUpdate">
                                    
                                    <input class="hide" value="0" type="text" id="hall_charge1" name="hall_charge" autocomplete="off">
                                </div>
                            </div><!--/.modal body-->
