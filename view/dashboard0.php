...
?> 
      ...
      <!-- /.row -->
      <h5>SuperAdmin,<strong><span style="color:#cf4ed4;"> Welcome back! </span></strong></h5>
...
?>            
        	...
        	<div class="col-md-4">
                <div id="calendar-container">
                    ...
                    <input type="hidden" id="my_type" value="Admin">                         
                 </div>
...
echo '<script>','ShowEvents("K", 100,"Admin");','</script>';
